...
int main(int argc, char ** argv) {
    ...
    printf("\n");
    printf("%f \n",angle(test8,north,test1));
    printf("%f \n",angle(test8,north,test2));
    printf("%f \n",angle(test8,north,test3));
    printf("%f \n",angle(test8,north,test4));
    printf("%f \n",angle(test8,north,test5));
    printf("%f \n",angle(test8,north,test6));
    printf("%f \n",angle(test8,north,test7));
        ...
        for(int j =0; j < count3*2 ;j+=2) {
            ...
            for(int l =0; l < count3*2 ;l+=2) {
                ...
                for(int k =0; k < count3*2 ;k+=2) {
                    ...
                    if (fabs(angle(p+j,p+i,p+k)-2.726165)<0.015 && fabs(angle(p+l,p+i,p+k)-2.493833)<0.015){
                        a=1;
                      a1=k;
                    }
                    if (fabs(angle(p+j,p+i,p+k)-2.515315)<0.015 && fabs(angle(p+l,p+i,p+k)-2.250788)<0.015){
                        b=1;
                        b1=k;
                    }
                    if (fabs(angle(p+j,p+i,p+k)-2.306016)<0.015 && fabs(angle(p+l,p+i,p+k)-2.047530)<0.015){
                        c=1;
                        c1=k;
                    }
                    if (fabs(angle(p+j,p+i,p+k)-2.059232)<0.015 && fabs(angle(p+l,p+i,p+k)-1.818661)<0.015){
                        d=1;
                        d1=k;
                    }
                    if (fabs(angle(p+j,p+i,p+k)-2.004482)<0.015 && fabs(angle(p+l,p+i,p+k)-1.787069)<0.015){
                        e=1;
                        e1=k;
                    }
                    if (fabs(angle(p+j,p+i,p+k)-1.706687)<0.015 && fabs(angle(p+l,p+i,p+k)-1.509963)<0.015){
                        f=1;
                        f1=k;
                    }
                    if (fabs(angle(p+j,p+i,p+k)-1.599079)<0.015 && fabs(angle(p+l,p+i,p+k)-1.395436)<0.015){
                        g=1;
                        dip=k;
